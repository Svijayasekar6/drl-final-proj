...
CHECKPOINT_PATH = os.path.join(
    ...
    "ray_results",
    "PPO_agent1_full",
    "PPO_Soccer_<trial_id>",     # e.g. PPO_Soccer_a8b44_00000_0_2024-...
    "checkpoint_<best_N>",       # e.g. checkpoint_000500
    "checkpoint-<N>",            # e.g. checkpoint-500
)


class RayAgent(AgentInterface):
    """Agent 1 — Vanilla PPO trained via self-play. No reward shaping."""
