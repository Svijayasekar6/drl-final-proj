"""
Agent 2 training — PPO + dense reward shaping + self-play.
Identical to Agent 1 except shaped_rewards=True, defensive_reward=True.
"""
...
if __name__ == "__main__":
    ...
    analysis = tune.run(
        ...
        config={
            ...
            # ── Model (identical to Agent 1) ──────────────────────────────────
            "model": {
                "fcnet_hiddens":    [256, 256],
                "fcnet_activation": "relu",
                "vf_share_layers":  True,
            },
            # ── PPO hyperparameters (identical to Agent 1) ────────────────────
